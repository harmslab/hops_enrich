...
def find_process_probability(enrich_dict,breaks=None,plot_name=None):
    ...
    Returns dictionary keying sequence to probability it came from peak with
    lowest mean, as well as (means,stds,areas) for the fit gaussians.
    """
    ...
    return out_dict, (means,stds,areas)
...
def calc_enrichment(alone_counts,
    ...
    returns seq_enrichment, prob this seq came from main gaussian, which
    process has highest probability, and the stats for the gaussian (means,stds,areas)
    """
    ...
    # values.
    seq_process, gaussian_stats = find_process_probability(seq_enrichment,plot_name=out_file)
    ...
    return seq_enrichment, seq_weight, seq_process, gaussian_stats
...
def main(argv=None):
    ...
    enrich, weight, process, gaussian_stats = calc_enrichment(alone_counts,
                                                              competitor_counts,
